...
\thanks{Manuscript submitted August 14, 2026; revised August 14, 2026. This work was conducted independently with self-hosted benchtop compute clusters.}%
...
As shown in Table~\ref{tab:results}, AdaptiveReplica reduces write p99 tail latency from $120.48\text{ms}$ to $13.50\text{ms}$ ($88.8\%$ improvement) while eliminating stale reads ($S_{\text{stale}} = 0$).
...
The author thanks the open-source distributed systems community for benchmark tooling and guidance.

\bibliographystyle{IEEEtran}
\bibliography{references}

\begin{IEEEbiographynophoto}{Sham Satish Thakare}
is an Independent Computer Science Researcher specializing in distributed systems, consensus algorithms, and cloud infrastructure performance. His research focuses on fault tolerance, quorum optimization, and tail-latency minimization in high-throughput distributed databases.
